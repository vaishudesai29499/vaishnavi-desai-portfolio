                ...
                <motion.section {...fadeUp} transition={{ delay: 0.15 }}>
                  ...
                  <div className="grid sm:grid-cols-3 gap-3">
                    {RESUME.achievements.map((item) => (
                      <div
                        key={item.title}
                        className="p-3 rounded-lg border border-amber-500/15 bg-amber-500/5 print:bg-amber-50 print:border-amber-200"
                      >
                        <span className="text-amber-400/80 text-[10px] font-mono print:text-amber-700">{item.year}</span>
                        <h4 className="text-white text-xs font-semibold mt-1 mb-1 print:text-slate-900">{item.title}</h4>
                        <p className="text-slate-500 text-[10px] leading-relaxed print:text-slate-600">{item.desc}</p>
                      </div>
                    ))}
                  </div>
                </motion.section>
