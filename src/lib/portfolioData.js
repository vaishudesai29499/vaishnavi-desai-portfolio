...
export const PROJECTS = [
  ...
  },
  {
    ...
    desc: 'Designed and developed a modern AI-focused portfolio showcasing full-stack projects, automation workflows, technical blogs, and professional achievements.',
    features: ['AI workflows', 'Responsive UI', 'Vercel deploy'],
    stack: ['React.js', 'JavaScript', 'Vercel'],
    github: null,
    demo: 'https://vaishnavi-desai-portfolio.vercel.app/',
    external: true,
    featured: false,
    gradient: 'from-pink-500/20 to-purple-600/10',
    details: {
      overview:
        "A modern AI-focused portfolio platform showcasing projects, technical blogs, achievements, and full-stack development expertise.",

      contributions: [
        "Designed and developed the complete UI/UX",
        "Built reusable React and Next.js components",
        "Integrated dynamic blog management",
        "Implemented responsive design across devices",
        "Optimized SEO and website performance"
      ],
      ...
      impact:
        "Created a professional platform to showcase technical expertise, projects, and content creation efforts."
    }
  },
  {
    slug: 'cyberinsurify',
...
export const RESUME = {
  ...
  highlights: [
    ...
    { label: 'Performance', value: '30%', unit: 'API Gain' },
    { label: 'Users', value: '300+', unit: 'Scaled' },
  ],
  experience: [
    {
